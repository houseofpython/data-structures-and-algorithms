...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach(element => {
    let startingIndex = element.indexOf(' ')+ 1;
    let newIngred = element.slice(startingIndex);
    let secondIndex = newIngred.indexOf(' ')+ 1;
    let finalIngred = newIngred.slice(secondIndex);
    result.push(finalIngred);
  });
